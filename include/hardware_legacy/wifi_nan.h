...
/* NAN Shared Key Security Cipher Suites */
typedef enum {
    NAN_CIPHER_SUITE_SHARED_KEY_NONE = 0,
    NAN_CIPHER_SUITE_SHARED_KEY_128,
    NAN_CIPHER_SUITE_SHARED_KEY_256,
    NAN_CIPHER_SUITE_SHARED_KEY_BOTH
} NanCipherSuiteSharedKeyType;
...
typedef struct {
    ...
    NanCipherSuiteSharedKeyType cipher_suites_supported;
} NanCapabilities;
...
typedef struct {
    ...
    /*
       ...
       receive corresponding to the Service Discovery frames.
       The unit is 512TU.
...
typedef struct {
    ...
    */
    ...
    /* Configure 2.4GHz Nan Data Path DW Band */
    ...
    /*
       ...
       The SDF includes in OTA when enabled.
    */

    u32 dw_2dot4g_interval_val;
    /* Configure 5GHz Nan Data Path DW Band */
...
typedef struct {
    ...
    */
    ...
    /* NAN Cipher Suite */
    NanCipherSuiteSharedKeyType peer_cipher_type;
